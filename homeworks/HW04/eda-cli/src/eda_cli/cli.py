...
def report(
    ...
    title: str = typer.Option("Отчёт", help="Название отчёта"),
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Существуют колонки с только одним значением: **{quality_flags['has_constant_columns']}**\n")
        f.write(f"- Слишком много значений '0': **{quality_flags['has_many_zero_values']}**\n\n")
